...
return  array(
    ...
    'MODULE_ALLOW_LIST'     =>  array('Haipin'),//允许访问的模块
    'MODULE_DENY_LIST'      =>  array('Common','Runtime','Exception','Logs','Model','Service'),
    'CONTROLLER_LEVEL'      =>  1,
    ...
    'VAR_PATHINFO'          =>  'service',    // 兼容模式PATHINFO获取变量例如 ?s=/module/action/id/1 后面的参数取决于URL_PATHINFO_DEPR
