...
class UserApi extends Api{
     ...
     */
    public function register($username, $password, $email, $mobile = '',$identityType = '',$branchId = 0){
        return $this->model->register($username, $password, $email, $mobile,$identityType,$branchId);
    }
    ...
    public function login($username, $password,$identityType,$type=1){
        return $this->model->login($username, $password,$identityType,$type);
    }
