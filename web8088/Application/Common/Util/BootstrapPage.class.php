 ...
 * 
 * @author jmjoy
 * @link http://blog.csdn.net/qq19124152/article/details/20062009
 *
 */
class BootstrapPage {  
    ...
    protected $coolPages   ;  
    // 分页显示定制  
    protected $config  =    array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'第一页','last'=>'<span id="lastspan">最后一页</span>','theme'=>'<ul><li class="disabled"><a href="#"> %totalRow% %header% %nowPage%/%totalPage% 页</a></li> %first%  %upPage% %prePage%  %linkPage% %downPage%  %nextPage% %end%</ul>');  
    // 默认分页变量名  
    protected $varPage;  
    /** 
     * 架构函数 
