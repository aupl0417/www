...
$(function () {
    ...
    function getAllInfo(flat, first) {
        ...
        if (publish == "用户发布") {
            if (first == "nearby") {
                args = {cate_id: cate_id, nearby: $nearby, greet: $greet, x: $x, y: $y, pages: pages};
                console.log(args);
            }
            else {
                args = {cate_id: cate_id, area_id: area_id, greet: $greet, pages: pages};
                console.log(args);
            }
            $.post(userCateUrl, args, function (msg) {
                if (first == "nearby") {
                    ...
                    temp = {cate_id: cate_id, area_id: area_id, greet: $greet, pages: pages};
                }
